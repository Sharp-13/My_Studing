...
# "Hello file world!" in it. Then write another script that opens myfile.txt, and reads and
...
new_file = open('C:\\Users\\Serhii\\PycharmProjects\\My_Studing\\lesson_11\\myfile.txt', 'a+')
